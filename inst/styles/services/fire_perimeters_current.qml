...
<qgis autoRefreshEnabled="0" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" version="4.2.1">
  <flags>
  ...
  <elevation band="1" enabled="0" symbology="Line" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{b1f78ea7-64b1-44a8-bba4-6f4b64028fc7}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{5be24212-d258-48e8-8bf1-88ce30abf253}" locked="0" pass="0">
          <Option type="Map">
  ...
  <customproperties>
    <Option type="Map">
      <Option name="identify/format" type="QString" value="Html"/>
    </Option>
  </customproperties>
  <mapTip/>
