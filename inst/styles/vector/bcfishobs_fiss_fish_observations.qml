...
<qgis autoRefreshEnabled="0" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="4.2.1-Belém do Pará">
  ...
  <elevation binding="Centroid" clamping="Terrain" extrusion="0" extrusionEnabled="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" symbology="Line" type="IndividualFeatures" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{b743ce9a-6d3c-4d29-a61d-3e95a147bd31}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{69961b2c-cf8e-42bd-9d8b-ddb99f67a602}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{cd44b48f-545c-4846-a9b5-11be58cba255}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{31eb6527-a09f-40ed-9a90-31ed97ee0f04}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" blendMode="0" capitalization="0" fieldName="species_code" fontFamily="Courier" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fontSize="5" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" forcedBold="0" forcedItalic="0" isExpression="0" legendString="Aa" multilineHeight="1" multilineHeightUnit="Percentage" namedStyle="" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" textOpacity="1" textOrientation="horizontal" useSubstitutions="0">
        <families/>
      ...
      <placement allowDegraded="0" centroidInside="0" centroidWhole="0" dist="0.59999999999999998" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" fitInPolygonOnly="0" geometryGenerator="" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" lineAnchorClipping="0" lineAnchorPercent="0.5" lineAnchorTextPoint="CenterOfText" lineAnchorType="0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetType="0" offsetUnits="MM" overlapHandling="PreventOverlap" overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" placement="0" placementFlags="10" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" priority="7" quadOffset="4" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" rotationAngle="0" rotationUnit="AngleDegrees" xOffset="0" yOffset="0"/>
    ...
    <DiagramCategory backgroundAlpha="255" backgroundColor="#ffffff" barWidth="5" diagramOrientation="Up" direction="0" enabled="0" height="15" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" maxScaleDenominator="1e+08" minScaleDenominator="0" minimumSize="0" opacity="1" penAlpha="255" penColor="#000000" penWidth="0" rotationOffset="270" scaleBasedVisibility="0" scaleDependency="Area" showAxis="1" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacing="5" spacingUnit="MM" spacingUnitScale="3x:0,0,0,0,0,0" width="15">
      ...
      <axisSymbol>
        <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
          ...
          <layer class="SimpleLine" enabled="1" id="{9460357d-b56f-4e9d-a96b-61f12a6d8978}" locked="0" pass="0">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="fish_observation_point_id">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="distance_to_stream">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="match_type">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="species_code">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="agency_id">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="agency_name">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="source_ref">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="activity_code">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="activity">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="life_stage_code">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="life_stage">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="acat_report_url">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="agency_name" index="16" name=""/>
    <alias field="source" index="17" name=""/>
    <alias field="source_ref" index="18" name=""/>
    <alias field="activity_code" index="19" name=""/>
    <alias field="activity" index="20" name=""/>
    <alias field="life_stage_code" index="21" name=""/>
    <alias field="life_stage" index="22" name=""/>
    <alias field="acat_report_url" index="23" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy field="agency_name" policy="Duplicate"/>
    <policy field="source" policy="Duplicate"/>
    <policy field="source_ref" policy="Duplicate"/>
    <policy field="activity_code" policy="Duplicate"/>
    <policy field="activity" policy="Duplicate"/>
    <policy field="life_stage_code" policy="Duplicate"/>
    <policy field="life_stage" policy="Duplicate"/>
    <policy field="acat_report_url" policy="Duplicate"/>
  </splitPolicies>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="agency_name"/>
    <default applyOnUpdate="0" expression="" field="source"/>
    <default applyOnUpdate="0" expression="" field="source_ref"/>
    <default applyOnUpdate="0" expression="" field="activity_code"/>
    <default applyOnUpdate="0" expression="" field="activity"/>
    <default applyOnUpdate="0" expression="" field="life_stage_code"/>
    <default applyOnUpdate="0" expression="" field="life_stage"/>
    <default applyOnUpdate="0" expression="" field="acat_report_url"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="agency_name" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="source" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="source_ref" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="activity_code" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="activity" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="life_stage_code" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="life_stage" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="acat_report_url" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="agency_name"/>
    <constraint desc="" exp="" field="source"/>
    <constraint desc="" exp="" field="source_ref"/>
    <constraint desc="" exp="" field="activity_code"/>
    <constraint desc="" exp="" field="activity"/>
    <constraint desc="" exp="" field="life_stage_code"/>
    <constraint desc="" exp="" field="life_stage"/>
    <constraint desc="" exp="" field="acat_report_url"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column hidden="0" name="fish_obsrvtn_pnt_distinct_id" type="field" width="-1"/>
      <column hidden="0" name="species_code" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="fish_obsrvtn_pnt_distinct_id"/>
    <field editable="1" name="species_code"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="fish_obsrvtn_pnt_distinct_id"/>
    <field labelOnTop="0" name="species_code"/>
  </labelOnTop>
  <reuseLastValue>
    <field name="fish_obsrvtn_pnt_distinct_id" reuseLastValue="0"/>
    <field name="species_code" reuseLastValue="0"/>
  </reuseLastValue>
