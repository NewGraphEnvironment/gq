...
New Graph produces maps across multiple tools — QGIS for field work, tmap for
...
Here's a study area map following New Graph cartographic conventions:

```{r tmap-study-area, fig.cap = "PSCIS crossings around the Bittner Creek watershed, classified by barrier status from the gq registry.", fig.alt = "Study area map of Bittner Creek watershed near Prince George showing streams, lakes, roads, railway, and PSCIS crossings"}
library(tmap)
sf_use_s2(FALSE)
...
```{r mapgl-map, fig.cap = "The same registry styles translated to MapLibre GL paint properties.", fig.alt = "Interactive MapLibre GL map of Bittner Creek watershed with PSCIS crossings"}
library(mapgl)
