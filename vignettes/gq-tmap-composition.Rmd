...
```{r map-composition, fig.cap = "Neexdzii Kwa subbasin: salmon habitat classified by use and barrier status, over the assessed PSCIS crossing inventory. Every colour, width and dash resolves from the gq registry.", fig.alt = "Map of a Neexdzii Kwa subbasin showing salmon habitat, crossings, fish observations, streams, lakes, wetlands, roads, and railway styled from the gq registry"}
