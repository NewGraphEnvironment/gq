...
- **Classified layers** (crossings, roads, habitat) use `do.call()` with
  `gq_tmap_style()` — classification field, colors, and labels all come from the
  registry. Labels follow the classes the data actually carries: the registry's
  26 road classes are matched to the handful present rather than recycled
