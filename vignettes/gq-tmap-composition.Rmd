...
own labels. At sub-watershed scale (zoom 10+), a gray canvas blended with
hillshade works well.
...
basemap_stars <- if (is.null(canvas) || is.null(relief)) {
  NULL
} else {
  ...
  gq_basemap_blend(canvas, relief, method = "gamma", gamma = 0.5)
}
